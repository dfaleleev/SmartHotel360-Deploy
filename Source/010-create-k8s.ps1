...
function MainScript($subscription, $acrName, $acrGroupName, $aksName, $aksGroupName, $spnClientId, $spnPassword)
{
...
$aksGroupName = $config.aksGroupName;
...
#MainScript $subscription $acrName $acrGroupName $aksName $aksGroupName $spnClientId $spnPassword
